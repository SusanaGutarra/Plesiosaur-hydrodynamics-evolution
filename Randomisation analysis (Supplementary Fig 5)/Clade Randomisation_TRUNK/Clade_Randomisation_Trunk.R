...
{
  # plot histograms
  cairo_pdf("randomisation_hist_Trunk_1-6.pdf",
            width  = 10,
...
write.csv(tbl, file = "randomisation_pval_Trunk_1-6.csv")
...
{
  # plot histograms
  cairo_pdf("randomisation_hist_Trunk_7-12.pdf",
            width  = 10,
            height = 14) #original 14
...
# write table to csv file
write.csv(tbl, file = "randomisation_pval_Trunk_7-12.csv")
...
{
  # plot histograms
  cairo_pdf("randomisation_hist_Trunk_13-18.pdf",
            width  = 10,
            height = 14) #original 14
...
# write table to csv file
write.csv(tbl, file = "randomisation_pval_Trunk_13-18.csv")
...
{
  # plot histograms
  cairo_pdf("randomisation_hist_Trunk_19-20.pdf",
            width  = 10,
            height = 14) #original 14
...
# write table to csv file
write.csv(tbl, file = "randomisation_pval_Trunk_19-20.csv")
